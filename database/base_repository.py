...
class BaseRepository(Generic[T]):
    ...
    def insert_one(self, record: T) -> ObjectId:
        ...
        return self._db._insert_one(
            collection_name=self._collection_name, record=record
        )
    ...
    def insert_many(self, records: List[T]) -> List[ObjectId]:
        ...
        return self._db._insert_many(
            collection_name=self._collection_name, records=records
        )
    ...
    def update_field(
        self, condition: Dict[str, Any], field_name: str, field_value: Any
    ) -> UpdateResult:
        """
    ...
    def find_all(self, limit: Optional[int] = 0, skip: int = 0) -> List[T]:
        ...
        """
        return self.find_many(condition={}, limit=limit, skip=skip)
